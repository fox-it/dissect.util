...
@pytest.mark.parametrize(*PARAMS)
def test_benchmark_lzvn_decompress(data: str, digest: str, benchmark: BenchmarkFixture) -> None:
    assert hashlib.sha256(benchmark(lzvn.decompress, bytes.fromhex(data))).hexdigest() == digest
