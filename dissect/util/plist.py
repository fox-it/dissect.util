...
from typing import TYPE_CHECKING, Any, BinaryIO, TypeAlias, TypedDict, Union, cast
...
class NSObject:
    ...
    def __getitem__(self, key: str) -> _Value:
        return self.nskeyed._parse(cast("_Value", self.obj[key]))
...
class NSDictionary(UserDict, NSObject):  # type: ignore
    def __init__(self, nskeyed: NSKeyedArchiver, obj: _NSDictionary):
        ...
        self.data: dict[_Value, Any] = {
            nskeyed._parse(key): obj for key, obj in zip(obj["NS.keys"], obj["NS.objects"], strict=False)
        }
